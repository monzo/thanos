...
type PrometheusResponseStats struct {
	Timings              *PrometheusResponseStats_Timings `protobuf:"bytes,1,opt,name=timings,proto3" json:"timings"`
	Samples              *PrometheusResponseStats_Samples `protobuf:"bytes,2,opt,name=samples,proto3" json:"samples"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (m *PrometheusResponseStats) GetTimings() *PrometheusResponseStats_Timings {
	if m != nil {
		return m.Timings
	}
	return nil
...
func (m *PrometheusResponseStats) GetSamples() *PrometheusResponseStats_Samples {
	if m != nil {
		return m.Samples
	}
	return nil
...
type PrometheusResponseStats_Timings struct {
	EvalTotalTime        float32  `protobuf:"fixed32,1,opt,name=EvalTotalTime,proto3" json:"evalTotalTime"`
	ResultSortTime       float32  `protobuf:"fixed32,2,opt,name=ResultSortTime,proto3" json:"resultSortTime"`
	QueryPreparationTime float32  `protobuf:"fixed32,3,opt,name=QueryPreparationTime,proto3" json:"queryPreparationTime"`
	InnerEvalTime        float32  `protobuf:"fixed32,4,opt,name=InnerEvalTime,proto3" json:"innerEvalTime"`
	ExecQueueTime        float32  `protobuf:"fixed32,5,opt,name=ExecQueueTime,proto3" json:"execQueueTime"`
	ExecTotalTime        float32  `protobuf:"fixed32,6,opt,name=ExecTotalTime,proto3" json:"execTotalTime"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *PrometheusResponseStats_Timings) Reset()         { *m = PrometheusResponseStats_Timings{} }
func (m *PrometheusResponseStats_Timings) String() string { return proto.CompactTextString(m) }
func (*PrometheusResponseStats_Timings) ProtoMessage()    {}
func (*PrometheusResponseStats_Timings) Descriptor() ([]byte, []int) {
	return fileDescriptor_9af7607b46ac39b7, []int{10, 0}
}
func (m *PrometheusResponseStats_Timings) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PrometheusResponseStats_Timings) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PrometheusResponseStats_Timings.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PrometheusResponseStats_Timings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrometheusResponseStats_Timings.Merge(m, src)
}
func (m *PrometheusResponseStats_Timings) XXX_Size() int {
	return m.Size()
}
func (m *PrometheusResponseStats_Timings) XXX_DiscardUnknown() {
	xxx_messageInfo_PrometheusResponseStats_Timings.DiscardUnknown(m)
}

var xxx_messageInfo_PrometheusResponseStats_Timings proto.InternalMessageInfo

func (m *PrometheusResponseStats_Timings) GetEvalTotalTime() float32 {
	if m != nil {
		return m.EvalTotalTime
	}
	return 0
}

func (m *PrometheusResponseStats_Timings) GetResultSortTime() float32 {
	if m != nil {
		return m.ResultSortTime
	}
	return 0
}

func (m *PrometheusResponseStats_Timings) GetQueryPreparationTime() float32 {
	if m != nil {
		return m.QueryPreparationTime
	}
	return 0
}

func (m *PrometheusResponseStats_Timings) GetInnerEvalTime() float32 {
	if m != nil {
		return m.InnerEvalTime
	}
	return 0
}

func (m *PrometheusResponseStats_Timings) GetExecQueueTime() float32 {
	if m != nil {
		return m.ExecQueueTime
	}
	return 0
}
...
func (m *PrometheusResponseStats_Timings) GetExecTotalTime() float32 {
	if m != nil {
		return m.ExecTotalTime
	}
	return 0
}

type PrometheusResponseStats_Samples struct {
	TotalQueryableSamples        int64                                             `protobuf:"varint,1,opt,name=TotalQueryableSamples,proto3" json:"totalQueryableSamples"`
	PeakSamples                  int64                                             `protobuf:"varint,2,opt,name=PeakSamples,proto3" json:"peakSamples"`
	TotalQueryableSamplesPerStep []*PrometheusResponseQueryableSamplesStatsPerStep `protobuf:"bytes,3,rep,name=totalQueryableSamplesPerStep,proto3" json:"totalQueryableSamplesPerStep"`
	XXX_NoUnkeyedLiteral         struct{}                                          `json:"-"`
	XXX_unrecognized             []byte                                            `json:"-"`
	XXX_sizecache                int32                                             `json:"-"`
}

func (m *PrometheusResponseStats_Samples) Reset()         { *m = PrometheusResponseStats_Samples{} }
func (m *PrometheusResponseStats_Samples) String() string { return proto.CompactTextString(m) }
func (*PrometheusResponseStats_Samples) ProtoMessage()    {}
func (*PrometheusResponseStats_Samples) Descriptor() ([]byte, []int) {
	return fileDescriptor_9af7607b46ac39b7, []int{10, 1}
}
func (m *PrometheusResponseStats_Samples) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PrometheusResponseStats_Samples) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PrometheusResponseStats_Samples.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PrometheusResponseStats_Samples) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrometheusResponseStats_Samples.Merge(m, src)
}
func (m *PrometheusResponseStats_Samples) XXX_Size() int {
	return m.Size()
}
func (m *PrometheusResponseStats_Samples) XXX_DiscardUnknown() {
	xxx_messageInfo_PrometheusResponseStats_Samples.DiscardUnknown(m)
}

var xxx_messageInfo_PrometheusResponseStats_Samples proto.InternalMessageInfo

func (m *PrometheusResponseStats_Samples) GetTotalQueryableSamples() int64 {
	if m != nil {
...
func (m *PrometheusResponseStats_Samples) GetPeakSamples() int64 {
	if m != nil {
...
func (m *PrometheusResponseStats_Samples) GetTotalQueryableSamplesPerStep() []*PrometheusResponseQueryableSamplesStatsPerStep {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*PrometheusResponseStats_Timings)(nil), "queryrange.PrometheusResponseStats.Timings")
	proto.RegisterType((*PrometheusResponseStats_Samples)(nil), "queryrange.PrometheusResponseStats.Samples")
...
var fileDescriptor_9af7607b46ac39b7 = []byte{
	...
	,
}
...
func (m *PrometheusResponseStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Timings != nil {
		{
			size, err := m.Timings.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PrometheusResponseStats_Timings) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PrometheusResponseStats_Timings) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PrometheusResponseStats_Timings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.ExecTotalTime != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ExecTotalTime))))
		i--
		dAtA[i] = 0x35
	}
	if m.ExecQueueTime != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ExecQueueTime))))
		i--
		dAtA[i] = 0x2d
	}
	if m.InnerEvalTime != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.InnerEvalTime))))
		i--
		dAtA[i] = 0x25
	}
	if m.QueryPreparationTime != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.QueryPreparationTime))))
		i--
		dAtA[i] = 0x1d
	}
	if m.ResultSortTime != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ResultSortTime))))
		i--
		dAtA[i] = 0x15
	}
	if m.EvalTotalTime != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.EvalTotalTime))))
		i--
		dAtA[i] = 0xd
	}
	return len(dAtA) - i, nil
...
func (m *PrometheusResponseStats_Samples) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PrometheusResponseStats_Samples) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PrometheusResponseStats_Samples) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PrometheusResponseStats_Timings) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PrometheusResponseStats_Samples) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PrometheusResponseStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Timings == nil {
				m.Timings = &PrometheusResponseStats_Timings{}
			}
		...
		case 2:
			...
			if m.Samples == nil {
				m.Samples = &PrometheusResponseStats_Samples{}
			}
...
func (m *PrometheusResponseStats_Timings) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field EvalTotalTime", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			iNdEx += 4
			m.EvalTotalTime = float32(math.Float32frombits(v))
		case 2:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResultSortTime", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.ResultSortTime = float32(math.Float32frombits(v))
		case 3:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryPreparationTime", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.QueryPreparationTime = float32(math.Float32frombits(v))
		case 4:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field InnerEvalTime", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.InnerEvalTime = float32(math.Float32frombits(v))
		case 5:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecQueueTime", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.ExecQueueTime = float32(math.Float32frombits(v))
		case 6:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecTotalTime", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.ExecTotalTime = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipQueryrange(dAtA[iNdEx:])
			if err != nil {
...
func (m *PrometheusResponseStats_Samples) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
